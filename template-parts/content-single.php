            ...
            <div class="col-md-12">
                ...
                <header class="entry-header">
                  ...
                  <?php
                    ...
                    <a href="#reply-title" class="entry-comments"><?php comments_number( esc_html__('No Responses. Be first to comment!','islemag'), esc_html__('One Response','islemag'), esc_html__('% Responses','islemag') ); ?></a>
                    <span class="entry-separator">/</span>
